 ...
 * extended view
 */
public class MyView3 extends UserView {
    Villain villain;
    ...
    public MyView3(World world, Villain villain, int width, int height) {
        super(world, width, height);
        this.villain = villain;
        this.background = new ImageIcon("data/game-background3.jpg").getImage();
